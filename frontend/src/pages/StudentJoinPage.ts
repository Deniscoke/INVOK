  ...
  <section class="auth-page">
    ...
    <form id="join-form" class="card stack" novalidate>
      <label class="field">Kód
        <input id="join-code" type="text" autocomplete="off" inputmode="latin" placeholder="napr. ABC123" required${codeAttr}>
      </label>
      <label class="field">Prezývka (len pri kóde triedy)
        <input id="join-pseudonym" type="text" autocomplete="off" placeholder="napr. Líška-07"${aliasAttr}>
      </label>
